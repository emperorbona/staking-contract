...
contract StakeTest is Test {
    ...
    function testMinimumUSDIsOne() public view {
        assertEq(stake.getMinimumUSD(), 1e18);
    }
    function testMinimumStakeTimeIsFive() public view {
        assertEq(stake.getMinimumStakeTime(), 5 minutes);
    }
    ...
    function testOnlyerCanWithdraw() public funded {
        vm.prank(USER);
        vm.expectRevert();
        stake.withdraw();
    }
    function testWithdrawWithASingleStaker() public funded {
        ...
        assertEq(
            endingOwnerBalance,
            startingOwnerBalance + startingStakeBalance
        );
    }
}
